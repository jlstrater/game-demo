package io.github.jlstrater.gamedemo.lwjgl3;
...
public class Lwjgl3Launcher {
    ...
    private static Lwjgl3Application createApplication() {
        return new Lwjgl3Application(new CampingGame(), getDefaultConfiguration());
    }

    private static Lwjgl3ApplicationConfiguration getDefaultConfiguration() {
        Lwjgl3ApplicationConfiguration configuration = new Lwjgl3ApplicationConfiguration();
        configuration.setTitle("Jenn's Camping Game");
        ...
        configuration.setWindowedMode((int) (CampingGame.WORLD_WIDTH * 70), (int) (CampingGame.WORLD_HEIGHT * 70));
